...
_「磁矩定义」一列中出现的「$p_m$」为「$p_\text{m}$」之误。_

_「毕-萨定律」一列中出现的「$\vec e_\text{r}$」为「$\vec e_r$」之误。_
...
_「介电常量」一列中出现的「$\varepsilon_0=q^2/fr^2$」为「$\varepsilon=q^2/4\pi fr^2$」之误。_

_「磁导率」一列中出现的「$\mu_0=aB/I$」为「$\mu=2\pi aB/I$」之误。_
...
_「毕奥-萨伐尔定律」一列中出现的「$\vec e_\text{r}$」为「$\vec e_r$」之误。_

_「自感定义」一列中出现的「$k_\text{安}$」为「$K_\text{安}$」之误。_

_「自感电动势」一列中出现的「$k_\text{安}$」为「$K_\text{安}$」之误。_
