...
|自感应 $L$|$1\kern{3 mu}\text{亨利}=10^9\kern{3 mu}\text{絕对 CGS (电磁) 单位 (厘米)}=\dfrac{1}{9\times10^{11}}\text{CGS 靜电单位}$。|
|磁感应通量 $\varPsi$|$1\kern{3 mu}\text{麦克斯韦}=10^{-8}\kern{3 mu}\text{韦伯}=1\kern{3 mu}\text{高斯}\times\text{厘米}^2=1\kern{3 mu}\text{絕对 CGS (电磁) 单位}=3\times10^{10}\text{CGS 靜电单位}$。|
