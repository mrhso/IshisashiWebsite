...
Where necessary the dimensions of quantities are given in parentheses. The symbol $c$ stands for the velocity of light in vacuum with dimensions ($lt^{-1}$).

|System|$\epsilon_0$|$\mu_0$|$\mathbf{D}$, $\mathbf{H}$|Macroscopic Maxwell Equations|Lorentz Force per Unit Charge|
|-|-|-|-|-|-|
|Electrostatic (esu)|$1$|$c^{-2}$ ($t^2l^{-2}$)|$\mathbf{D}=\mathbf{E}+4\pi\mathbf{P}$<br>$\mathbf{H}=c^2\mathbf{B}-4\pi\mathbf{M}$|$\boldsymbol\nabla\cdot\mathbf{D}=4\pi\rho$<br>$\boldsymbol\nabla\times\mathbf{H}=4\pi\mathbf{J}+\dfrac{\partial\mathbf{D}}{\partial t}$<br>$\boldsymbol\nabla\times\mathbf{E}+\dfrac{\partial\mathbf{B}}{\partial t}=0$<br>$\boldsymbol\nabla\cdot\mathbf{B}=0$|$\mathbf{E}+\mathbf{v}\times\mathbf{B}$|
|Electromagnetic (emu)|$c^{-2}$ ($t^2l^{-2}$)|$1$|$\mathbf{D}=\dfrac{1}{c^2}\mathbf{E}+4\pi\mathbf{P}$<br>$\mathbf{H}=\mathbf{B}-4\pi\mathbf{M}$|$\boldsymbol\nabla\cdot\mathbf{D}=4\pi\rho$<br>$\boldsymbol\nabla\times\mathbf{H}=4\pi\mathbf{J}+\dfrac{\partial\mathbf{D}}{\partial t}$<br>$\boldsymbol\nabla\times\mathbf{E}+\dfrac{\partial\mathbf{B}}{\partial t}=0$<br>$\boldsymbol\nabla\cdot\mathbf{B}=0$|$\mathbf{E}+\mathbf{v}\times\mathbf{B}$|
|Gaussian|$1$|$1$|$\mathbf{D}=\mathbf{E}+4\pi\mathbf{P}$<br>$\mathbf{H}=\mathbf{B}-4\pi\mathbf{M}$|$\boldsymbol\nabla\cdot\mathbf{D}=4\pi\rho$<br>$\boldsymbol\nabla\times\mathbf{H}=\dfrac{4\pi}{c}\mathbf{J}+\dfrac{1}{c}\dfrac{\partial\mathbf{D}}{\partial t}$<br>$\boldsymbol\nabla\times\mathbf{E}+\dfrac{1}{c}\dfrac{\partial\mathbf{B}}{\partial t}=0$<br>$\boldsymbol\nabla\cdot\mathbf{B}=0$|$\mathbf{E}+\dfrac{\mathbf{v}}{c}\times\mathbf{B}$|
|Heaviside-Lorentz|$1$|$1$|$\mathbf{D}=\mathbf{E}+\mathbf{P}$<br>$\mathbf{H}=\mathbf{B}-\mathbf{M}$|$\boldsymbol\nabla\cdot\mathbf{D}=\rho$<br>$\boldsymbol\nabla\times\mathbf{H}=\dfrac{1}{c}\left(\mathbf{J}+\dfrac{\partial\mathbf{D}}{\partial t}\right)$<br>$\boldsymbol\nabla\times\mathbf{E}+\dfrac{1}{c}\dfrac{\partial\mathbf{B}}{\partial t}=0$<br>$\boldsymbol\nabla\cdot\mathbf{B}=0$|$\mathbf{E}+\dfrac{\mathbf{v}}{c}\times\mathbf{B}$|
|SI|$\dfrac{10^{7}}{4\pi c^2}$ ($I^2t^4m^{-1}l^{-3}$)|$4\pi\times10^{-7}$ ($mlI^{-2}t^{-2}$)|$\mathbf{D}=\epsilon_0\mathbf{E}+\mathbf{P}$<br>$\mathbf{H}=\dfrac{1}{\mu_0}\mathbf{B}-\mathbf{M}$|$\boldsymbol\nabla\cdot\mathbf{D}=\rho$<br>$\boldsymbol\nabla\times\mathbf{H}=\mathbf{J}+\dfrac{\partial\mathbf{D}}{\partial t}$<br>$\boldsymbol\nabla\times\mathbf{E}+\dfrac{\partial\mathbf{B}}{\partial t}=0$<br>$\boldsymbol\nabla\cdot\mathbf{B}=0$|$\mathbf{E}+\mathbf{v}\times\mathbf{B}$|

### Appendix Table 3　Conversion Table for Symbols and Formulas
The symbols for mass, length, time, force, and other not specifically electromagnetic quantities are unchanged. To convert any equation in SI variables to the corresponding equation in Gaussian quantities, on both sides of the equation replace the relevant symbols listed below under “SI” by the corresponding “Gaussian” symbols listed on the left. The reverse transformation is also allowed. Residual powers of $\mu_0\epsilon_0$ should be eliminated in favor of the speed of light ($c^2\mu_0\epsilon_0=1$). Since the length and time symbols are unchanged, quantities that differ dimensionally from one another only by powers of length and/or time are grouped together where possible.

|Quantity|Gaussian|SI|
|-|-|-|
|Velocity of light|$c$|$(\mu_0\epsilon_0)^{-1/2}$|
|Electric field (potential, voltage)|$\mathbf{E}(\Phi,V)/\sqrt{4\pi\epsilon_0}$|$\mathbf{E}(\Phi,V)$|
|Displacement|$\sqrt{\epsilon_0/4\pi}\mathbf{D}$|$\mathbf{D}$|
|Charge density (charge, current density, current, polarization)|$\sqrt{4\pi\epsilon_0}\rho(q,\mathbf{J},I,\mathbf{P})$|$\rho(q,\mathbf{J},I,\mathbf{P})$|
|Magnetic induction|$\sqrt{\mu_0/4\pi}\mathbf{B}$|$\mathbf{B}$|
|Magnetic field|$\mathbf{H}/\sqrt{4\pi\mu_0}$|$\mathbf{H}$|
|Magnetization|$\sqrt{4\pi/\mu_0}\mathbf{M}$|$\mathbf{M}$|
|Conductivity|$4\pi\epsilon_0\sigma$|$\sigma$|
|Dielectric constant|$\epsilon_0\epsilon$|$\epsilon$|
|Magnetic permeability|$\mu_0\mu$|$\mu$|
|Resistance (impedance)|$R(Z)/4\pi\epsilon_0$|$R(Z)$|
|Inductance|$L/4\pi\epsilon_0$|$L$|
|Capacitance|$4\pi\epsilon_0C$|$C$|

$c=2.99792458\times10^8\kern{3 mu}\text{m}/\text{s}$

$\epsilon_0=8.8541878\dots\kern{0 mu}\times10^{-12}\kern{3 mu}\text{F}/\text{m}$

$\mu_0=1.2566370\dots\kern{0 mu}\times10^{-6}\kern{3 mu}\text{H}/\text{m}$

$\sqrt{\dfrac{\mu_0}{\epsilon_0}}=376.7303\dots\kern{3 mu}\Omega$

### Appendix Table 4　Conversion Table for Given Amounts of a Physical Quantity
The table is arranged so that a given amount of some physical quantity, expressed as so many SI or Gaussian units of that quantity, can be expressed as an equivalent number of units in the other system. Thus the entries in each row stand for the same amount, expressed in different units. All factors of $3$ (apart from exponents) should, for accurate work, be replaced by $(2.99792458)$, arising from the numerical value of the velocity of light. For example, in the row for displacement ($D$), the entry $\left(12\pi\times10^5\right)$ is actually $\left(2.99792458\times4\pi\times10^5\right)$ and “$9$” is actually $10^{-16}c^2=8.98755\dots$. Where a name for a unit has been agreed on or is in common usage, that name is given. Otherwise, one merely reads so many Gaussian units, or SI units.

|Physical Quantity|Symbol|SI|Gaussian|
|-|-|-|-|
|Length|$l$|$1\kern{3 mu}\text{meter}\text{ }(\text{m})$|$10^2\kern{3 mu}\text{centimeters}\text{ }(\text{cm})$|
|Mass|$m$|$1\kern{3 mu}\text{kilogram}\text{ }(\text{kg})$|$10^3\kern{3 mu}\text{grams}\text{ }(\text{g})$|
|Time|$t$|$1\kern{3 mu}\text{second}\text{ }(\text{s})$|$1\kern{3 mu}\text{second}\text{ }(\text{s})$|
|Frequency|$\nu$|$1\kern{3 mu}\text{hertz}\text{ }(\text{Hz})$|$1\kern{3 mu}\text{hertz}\text{ }(\text{Hz})$|
|Force|$F$|$1\kern{3 mu}\text{newton}\text{ }(\text{N})$|$10^5\kern{3 mu}\text{dynes}$|
|Work|$W$|$1\kern{3 mu}\text{joule}\text{ }(\text{J})$|$10^7\kern{3 mu}\text{ergs}$|
|Energy|$U$|↑|↑|
|Power|$P$|$1\kern{3 mu}\text{watt}\text{ }(\text{W})$|$10^7\kern{3 mu}\text{ergs}\kern{3 mu}\text{s}^{-1}$|
|Charge|$q$|$1\kern{3 mu}\text{coulomb}\text{ }(\text{C})$|$3\times10^9\kern{3 mu}\text{statcoulombs}$|
|Charge density|$\rho$|$1\kern{3 mu}\text{C}\kern{3 mu}\text{m}^{-3}$|$3\times10^3\kern{3 mu}\text{statcoul}\kern{3 mu}\text{cm}^{-3}$|
|Current|$I$|$1\kern{3 mu}\text{ampere}\text{ }(\text{A})$|$3\times10^9\kern{3 mu}\text{statamperes}$|
|Current density|$J$|$1\kern{3 mu}\text{A}\kern{3 mu}\text{m}^{-2}$|$3\times10^5\kern{3 mu}\text{statamp}\kern{3 mu}\text{cm}^{-2}$|
|Electric field|$E$|$1\kern{3 mu}\text{volt}\kern{3 mu}\text{m}^{-1}\text{ }\left(\text{V}\kern{3 mu}\text{m}^{-1}\right)$|$\dfrac{1}{3}\times10^{-4}\kern{3 mu}\text{statvolt}\kern{3 mu}\text{cm}^{-1}$|
|Potential|$\Phi$, $V$|$1\kern{3 mu}\text{volt}\text{ }(\text{V})$|$\dfrac{1}{300}\kern{3 mu}\text{statvolt}$|
|Polarization|$P$|$1\kern{3 mu}\text{C}\kern{3 mu}\text{m}^{-2}$|$3\times10^5\kern{3 mu}\text{dipole moment}\kern{3 mu}\text{cm}^{-3}$|
|Displacement|$D$|$1\kern{3 mu}\text{C}\kern{3 mu}\text{m}^{-2}$|$12\pi\times10^5\kern{3 mu}\text{statvolt}\kern{3 mu}\text{cm}^{-1}\text{ }\left(\text{statcoul}\kern{3 mu}\text{cm}^{-2}\right)$|
|Conductivity|$\sigma$|$1\kern{3 mu}\text{siemens}\kern{3 mu}\text{m}^{-1}$|$9\times10^9\kern{3 mu}\text{s}^{-1}$|
|Resistance|$R$|$1\kern{3 mu}\text{ohm}\text{ }(\Omega)$|$\dfrac{1}{9}\times10^{-11}\kern{3 mu}\text{s}\kern{3 mu}\text{cm}^{-1}$|
|Capacitance|$C$|$1\kern{3 mu}\text{farad}\text{ }(\text{F})$|$9\times10^{11}\kern{3 mu}\text{cm}$|
|Magnetic flux|$\phi$, $F$|$1\kern{3 mu}\text{weber}\text{ }(\text{Wb})$|$10^8\kern{3 mu}\text{gauss}\kern{3 mu}\text{cm}^2\text{ }\text{or}\text{ }\text{maxwells}$|
|Magnetic induction|$B$|$1\kern{3 mu}\text{tesla}\text{ }(\text{T})$|$10^4\kern{3 mu}\text{gauss}\text{ }(\text{G})$|
|Magnetic field|$H$|$1\kern{3 mu}\text{A}\kern{3 mu}\text{m}^{-1}$|$4\pi\times10^{-3}\kern{3 mu}\text{oersted}\text{ }(\text{Oe})$|
|Magnetization|$M$|$1\kern{3 mu}\text{A}\kern{3 mu}\text{m}^{-1}$|$10^{-3}\kern{3 mu}\text{magnetic moment}\kern{3 mu}\text{cm}^{-3}$|
|Inductance\*|$L$|$1\kern{3 mu}\text{henry}\text{ }(\text{H})$|$\dfrac{1}{9}\times10^{-11}$|

\*There is some confusion about the unit of inductance in Gaussian units. This stems from the use by some authors of a modified system of Gaussian units in which current is measured in electromagnetic units, so that the connection between charge and current is $I_m=(1/c)(dq/dt)$. Since inductance is defined through the induced voltage $V=L(dI/dt)$ or the energy $U=\dfrac{1}{2}LI^2$, the choice of current defined in Section 2 means that our Gaussian unit of inductance is equal in magnitude and dimensions ($t^2l^{-1}$) to the electrostatic unit of inductance. The electromagnetic current $I_m$ is related to our Gaussian current $I$ by the relation $I_m=(1/c)I$. From the energy definition of inductance, we see that the electromagnetic inductance $L_m$ is related to our Gaussian inductance $L$ through $L_m=c^2L$. Thus $L_m$ has the dimensions of length. The modified Gaussian system generally uses the electromagnetic unit of inductance, as well as current. Then the voltage relation reads $V=(L_m/c)(dI_m/dt)$. The numerical connection between units of inductance is

$1\kern{3 mu}\text{henry}=\dfrac{1}{9}\times10^{-11}\kern{3 mu}\text{Gaussian (es) unit}=10^9\kern{3 mu}\text{emu}$
...
|mks (rationalized)|Gaussian\* (cgs)|Heaviside-Lorentz (cgs)|“Natural” units<br>$c=\hbar=1$<br>(rationalized)|
|-|-|-|-|
|$\boldsymbol\nabla\cdot\mathbf{E}=\rho/\epsilon_0$|$\boldsymbol\nabla\cdot\mathbf{E}=4\pi\rho$|$\boldsymbol\nabla\cdot\mathbf{E}=\rho$|$\boldsymbol\nabla\cdot\mathbf{E}=\rho$|
|$\displaystyle\mathbf{E}=\dfrac{1}{4\pi\epsilon_0}\int\dfrac{\rho\mathbf{r}}{r^3}dv$|$\displaystyle\mathbf{E}=\int\dfrac{\rho\mathbf{r}}{r^3}dv$|$\displaystyle\mathbf{E}=\dfrac{1}{4\pi}\int\dfrac{\rho\mathbf{r}}{r^3}dv$|$\displaystyle\mathbf{E}=\dfrac{1}{4\pi}\int\dfrac{\rho\mathbf{r}}{r^3}dv$|
|$\boldsymbol\nabla\times\mathbf{B}=\mu_0\left(\mathbf{j}+\epsilon_0\dfrac{\partial\mathbf{E}}{\partial t}\right)$<br>$\displaystyle\mathbf{B}=\dfrac{\mu_0}{4\pi}\int\dfrac{\left(\mathbf{j}+\epsilon_0\dfrac{\partial\mathbf{E}}{\partial t}\right)\times\mathbf{r}}{r^3}dv$|$\boldsymbol\nabla\times\mathbf{B}=4\pi\mathbf{j}+\dfrac{1}{c}\dfrac{\partial\mathbf{E}}{\partial t}$<br>$\displaystyle\mathbf{B}=\int\dfrac{\left(\mathbf{j}+\dfrac{1}{4\pi c}\dfrac{\partial\mathbf{E}}{\partial t}\right)\times\mathbf{r}}{r^3}dv$|$\boldsymbol\nabla\times\mathbf{B}=\mathbf{j}+\dfrac{1}{c}\dfrac{\partial\mathbf{E}}{\partial t}$<br>$\displaystyle\mathbf{B}=\dfrac{1}{4\pi}\int\dfrac{\left(\mathbf{j}+\dfrac{1}{c}\dfrac{\partial\mathbf{E}}{\partial t}\right)\times\mathbf{r}}{r^3}dv$|$\boldsymbol\nabla\times\mathbf{B}=\mathbf{j}+\dfrac{\partial\mathbf{E}}{\partial t}$<br>$\displaystyle\mathbf{B}=\dfrac{1}{4\pi}\int\dfrac{\left(\mathbf{j}+\dfrac{\partial\mathbf{E}}{\partial t}\right)\times\mathbf{r}}{r^3}dv$|
|$\boldsymbol\nabla\cdot\mathbf{B}=0$<br>$\boldsymbol\nabla\times\mathbf{E}=-\dfrac{\partial\mathbf{B}}{\partial t}$|$\boldsymbol\nabla\cdot\mathbf{B}=0$<br>$c\boldsymbol\nabla\times\mathbf{E}=-\dfrac{\partial\mathbf{B}}{\partial t}$|$\boldsymbol\nabla\cdot\mathbf{B}=0$<br>$c\boldsymbol\nabla\times\mathbf{E}=-\dfrac{\partial\mathbf{B}}{\partial t}$|$\boldsymbol\nabla\cdot\mathbf{B}=0$<br>$\boldsymbol\nabla\times\mathbf{E}=-\dfrac{\partial\mathbf{B}}{\partial t}$|
|$\mathbf{F}=e(\mathbf{E}+\mathbf{u}\times\mathbf{B})$|$\mathbf{F}=e\left(\mathbf{E}+\dfrac{\mathbf{u}}{c}\times\mathbf{B}\right)$|$\mathbf{F}=e\left(\mathbf{E}+\dfrac{\mathbf{u}}{c}\times\mathbf{B}\right)$|$\mathbf{F}=e(\mathbf{E}+\mathbf{u}\times\mathbf{B})$|
|$\mathbf{B}=\boldsymbol\nabla\times\mathbf{A}$<br>$\mathbf{E}=-\boldsymbol\nabla\phi-\dfrac{\partial\mathbf{A}}{\partial t}$|$\mathbf{B}=\boldsymbol\nabla\times\mathbf{A}$<br>$\mathbf{E}=-\boldsymbol\nabla\phi-\dfrac{1}{c}\dfrac{\partial\mathbf{A}}{\partial t}$|$\mathbf{B}=\boldsymbol\nabla\times\mathbf{A}$<br>$\mathbf{E}=-\boldsymbol\nabla\phi-\dfrac{1}{c}\dfrac{\partial\mathbf{A}}{\partial t}$|$\mathbf{B}=\boldsymbol\nabla\times\mathbf{A}$<br>$\mathbf{E}=-\boldsymbol\nabla\phi-\dfrac{\partial\mathbf{A}}{\partial t}$|
|$\boldsymbol\nabla\cdot\mathbf{j}+\dfrac{\partial\rho}{\partial t}=0$<br>$\boldsymbol\nabla\cdot\mathbf{A}+\dfrac{1}{c^2}\dfrac{\partial\phi}{\partial t}=0$|$\boldsymbol\nabla\cdot\mathbf{j}+\dfrac{1}{c}\dfrac{\partial\rho}{\partial t}=0$<br>$\boldsymbol\nabla\cdot\mathbf{A}+\dfrac{1}{c}\dfrac{\partial\phi}{\partial t}=0$|$\boldsymbol\nabla\cdot\mathbf{j}+\dfrac{1}{c}\dfrac{\partial\rho}{\partial t}=0$<br>$\boldsymbol\nabla\cdot\mathbf{A}+\dfrac{1}{c}\dfrac{\partial\phi}{\partial t}=0$|$\boldsymbol\nabla\cdot\mathbf{j}+\dfrac{\partial\rho}{\partial t}=0$<br>$\boldsymbol\nabla\cdot\mathbf{A}+\dfrac{\partial\phi}{\partial t}=0$|
|$F^{ij}=\left(\begin{matrix}0 & -cB_z & cB_y & +E_x\cr cB_z & 0 & -cB_x & +E_y\cr-cB_y & cB_x & 0 & +E_z\cr-E_x & -E_y & -E_z & 0\end{matrix}\right)$<br>$\dfrac{\partial F^{ij}}{\partial x^i}=\dfrac{j^j}{\epsilon_0}$|$F^{ij}=\left(\begin{matrix}0 & -B_z & B_y & +E_x\cr B_z & 0 & -B_x & +E_y\cr-B_y & B_x & 0 & +E_z\cr-E_x & -E_y & -E_z & 0\end{matrix}\right)$<br>$\dfrac{\partial F^{ij}}{\partial x^i}=4\pi j^j$|$F^{ij}$ has same form as in Gaussian units<br>$\dfrac{\partial F^{ij}}{\partial x^i}=j^j$|$F^{ij}$ has same form as in Gaussian units<br>$\dfrac{\partial F^{ij}}{\partial x^i}=j^j$|

\* In some textbooks employing Gaussian units $\mathbf{j}$ is measured in esu. In that case the equations are those given here except that $\mathbf{j}$ appears with a factor $1/c$.

_此处电流密度 $\vec j$ 的 Gauss / Heaviside-Lorentz 单位取电磁单位而非静电单位。_

_「自然」单位制基于 Heaviside-Lorentz 单位制。_

_此处电磁场张量 $F^{ij}$、4-电流密度 $j^j$ 的量纲与电场强度 $\vec E$、电荷体密度 $\rho$ 保持一致。_

### Table I-2　Conversion Factors
|Multiply the number of mks units below|by|to obtain the number of Gaussian (cgs) units of|
|-|-|-|
|$\text{ampere}$|$10^{-1}$|current in $\text{abamperes}$|
|$\text{ampere}/\text{meter}^2$|$10^{-5}$|current density in $\text{abampere}/\text{cm}^2$|
|$\text{coulomb}$|$3\times10^9$\*|charge in $\text{esu}$|
|$\text{coulomb}/\text{meter}^3$|$3\times10^3$\*|charge density in $\text{esu}/\text{cm}^3$|
|$\text{farad}=\text{coulomb}/\text{volt}$|$9\times10^{-11}$\*|capacitance in $\text{cm}$|
|$\text{henry}=\text{volt}\kern{3 mu}\text{sec}/\text{ampere}$|$10^9$|inductance in $\text{emu}$|
|$\text{joule}$|$10^7$|energy in $\text{ergs}$|
|$\text{newton}$|$10^5$|force in $\text{dynes}$|
|$\text{ohm}=\text{volt}/\text{ampere}$|$\dfrac{1}{30}$\*|resistance in $\text{esu}$ of potential per $\text{abampere}$|
||$\dfrac{1}{9}\times10^{11}$\*|resistance in $\text{esu}$|
|$\text{volt}$|$\dfrac{1}{300}\*$|potential in $\text{esu}$|
|$\text{volt}/\text{meter}$|$\dfrac{1}{3}\times10^4$\*|electric field intensity $\mathbf{E}$ in $\text{esu}$|
|$\text{coulomb}/\text{meter}^2$|$12\pi\times10^5$\*|electric displacement $\mathbf{D}$ in $\text{esu}$|
|$\text{weber}=\text{volt}\kern{3 mu}\text{second}$|$10^8$|magnetic flux in $\text{maxwells}$|
|$\text{weber}/\text{meter}^2$|$10^4$|flux density $\mathbf{B}$ in $\text{gauss}$|
|$\text{ampere-turns}/\text{meter}$|$4\pi/10^3$|field intensity $\mathbf{H}$ in $\text{oersteds}$|
|$\text{mho}/\text{meter}$|$\dfrac{3}{10}$\*|conductivity in $\text{abamperes}/\text{cm}^2/\text{esu}$ of field intensity|
|$\text{ampere turns}$|$4\pi/10$|magnetomotive force in $\text{gilberts}$|

\* In all conversion factors marked by an asterisk $3$ is used for $c/10^{10}$, where in this definition $c$ is measured in cgs units. If higher accuracy is desired, a more precise value of $c$ must be substituted. DuMond and Cohen give $c=299792.9\pm0.8\kern{3 mu}\text{km}/\text{sec}$. \[*Revs. Mordern Phys.* **25,** 961 (1953).\]

_此处电流强度（current）、电流密度（current density）、电感（inductance）的 Gauss 单位取电磁单位而非静电单位；电阻（resistance）的 Gauss 单位既列出按 $\dfrac{V\_\text{ESU}}{I\_\text{EMU}}$（$V$ 为电压，$I$ 为电流）定义的单位，也列出纯静电单位；电导率（conductivity）只取按 $\dfrac{I\_\text{EMU}}{SE\_\text{ESU}}$（$I$ 为电流，$S$ 为面积，$E$ 为电场强度）定义的单位。_

_「capacitance」一列中出现的「$9\times10^{-11}$」为「$9\times10^{11}$」之误。_

_「resistance」一列中出现的「$\dfrac{1}{9}\times10^{11}$」为「$\dfrac{1}{9}\times10^{-11}$」之误。_

_「electric field intensity」一列中出现的「$\dfrac{1}{3}\times10^4$」为「$\dfrac{1}{3}\times10^{-4}$」之误。_
