...
|音名|十二平均律步（距 C）|十二平均律质因列（距 C）|Werckmeister III 质因列（距 C）|
|-|-|-|-|
...
|音名|十二平均律步（距 C）|十二平均律质因列（距 C）|Werckmeister IV 质因列（距 C）|
|-|-|-|-|
|C|$0$|$\left\[\begin{matrix}0\end{matrix}\right\]$|$\left\[\begin{matrix}0\cr0\end{matrix}\right\]$|
...
|音名|十二平均律步（距 C）|十二平均律质因列（距 C）|Werckmeister V 质因列（距 C）|
|-|-|-|-|
|C|$0$|$\left\[\begin{matrix}0\end{matrix}\right\]$|$\left\[\begin{matrix}0\cr0\end{matrix}\right\]$|
