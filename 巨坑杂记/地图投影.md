...
$x_0=q=\dfrac{\left(0.9953537\varphi+0.01476138\varphi^3\right)R}{\mu_0}$

设 $\mu_0=10000000$，$R=6371116\kern{3 mu}\text{m}$，$\varphi$ 以弧度计

代入上式

$x_0=q=63.41514\varphi+0.9404646\varphi^3$
...
$\delta\varphi_i=\dfrac{\delta\varphi_n}{\lambda_n}b(1-C\lambda_i)\lambda_i$

$\rho=\dfrac{y_n^2+(x_n-x_0)^2}{2(x_n-x_0)}$

式中 $b=1.10$，$C=0.0005050505$。

$x_n$、$y_n$ 是边缘经线上（$\Delta\lambda=180^\circ$）根据所设计的经、纬线草图所量取的直角坐标值（见图 12-6）。

$\delta\varphi_i$ 是某一纬线上各经线的极角；$\lambda_n$ 是边缘经线与中央经线的经差，通常 $\lambda_n=180^\circ$；$\lambda_i$ 为各点经线与中央经线的经差。

赤道上的直角坐标值

$y_i=\dfrac{y_n}{\lambda_n}b(1-C\lambda_i)\lambda_i$

$x_i=0$

按 (12-1) 可求得各点的直角坐标

$x=q-\rho\cos\delta\varphi_i$

$y=\rho\sin\delta\varphi_i$

式中 $q=\rho+x_0$。

表 12-2 是该投影的纬圈半径 $\rho$ 和极角 $\delta\varphi_n$。

##### 表 12-2
|$\varphi$|$10^\circ$|$15^\circ$|$20^\circ$|回归线|$30^\circ$|$40^\circ$|$45^\circ$|
|-|-|-|-|-|-|-|-|
|$\rho$|$2399.943$|$1643.348$|$1201.174$|$1024.159$|$807.634$|$618.060$|$556.629$|
|$\delta\varphi_n$|$3^\circ54'10''.5$|$5^\circ38'09''.5$|$7^\circ35'46''.0$|$8^\circ47'52''.0$|$10^\circ51'26''.0$|$13^\circ29'08''.5$|$14^\circ31'58''.5$|

|$\varphi$|$50^\circ$|$60^\circ$|极圈|$70^\circ$|$75^\circ$|$80^\circ$|$90^\circ$|
|-|-|-|-|-|-|-|-|
|$\rho$|$507.561$|$430.763$|$388.633$|$375.478$|$372.030$|$388.525$|$508.062$|
|$\delta\varphi_n$|$15^\circ24'15''.5$|$16^\circ39'04''.0$|$17^\circ12'31''.5$|$17^\circ05'27''.0$|$16^\circ11'00''.5$|$14^\circ28'57''.5$|$9^\circ20'42''.5$|
...
（根据王诗阳、王雪《有关等差分纬线多圆锥投影的正反解变换新算法》，$c$ 的精确值为 $\dfrac{b-1}{b\pi}=\dfrac{1}{11\pi}$，这里不作修改）
