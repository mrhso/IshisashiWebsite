...
![y=\dfrac{5}{4}R\ln\tan\left(\dfrac{\pi}{4}+\dfrac{2\varphi}{5}\right)](https://latex.codecogs.com/svg.latex?\dfrac{5}{4}R\ln\tan\left(\dfrac{\pi}{4}+\dfrac{2\varphi}{5}\right))
