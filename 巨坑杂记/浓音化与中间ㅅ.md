...
可是纯汉字词那种不加中间ㅅ的呢？基本以南朝鲜正字法为准。不过朝鲜文本还有需要注意的问题，例如「새별」在朝鲜现行规范其实是不浓音化的，所以转写为「saebyeol」。

## 中间ㅅ的正字法
一些中间ㅅ已经固化而视为固定前缀，例如「웃자리」中的「웃」。在这种情况下无论是朝鲜还是南朝鲜均读为「욷짜리」，而没有「우짜리」的读法。此时应当视为因塞音韵尾引起的浓音化。
...
有中间ㅅ的因为只有含 t 尾的读法，同样应当视为因塞音韵尾引起的浓音化。

朝鲜 1992 年式原文中的「새별邑」是 1977 年改的地名，当然 2005 年改回了原名庆源。没有写成「샛별」并且读成「새뼐」（按朝鲜现行规范，表金星的「새별」也应读为「새별」）就很正常了。

上文提到，南朝鲜有一部分纯汉字词加中间ㅅ。实际上，[《谚文正写法》](https://ja.wikisource.org/wiki/%E9%9F%93%E3%90%8E%E6%AD%A3%E6%9B%B8%E6%B3%95(%E7%AC%AC2014-39%E5%8F%B7))中规定了六个例外。
