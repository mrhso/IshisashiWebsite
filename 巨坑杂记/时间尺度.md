...
这样 $(x_p,y_p)\rightarrow(0,0)$ 时 $(x_p\sin\lambda+y_p\cos\lambda)\tan\varphi$ 便成为 $\Delta\lambda=\dfrac{\alpha-\beta\tan\lambda}{\beta+\alpha\tan\lambda}$ 的等价无穷小，于是可以直接把它当作 \(\Delta\lambda\)。
