...
1958 年，英国国家物理实验室与美国海军天文台的联合实验[结果](http://www.leapsecond.com/history/1958-PhysRev-v1-n3-Markowitz-Hall-Essen-Parry.pdf)表明，一个历书秒相当于铯-133 基态超精细能级跃迁的 9192631770 个周期。这就为 SI 秒的新定义打下了实验基础。
...
20 世纪 60 年代，美国和德国的长波无线电广播时间信号使用步进原子时（英 Stepped Atomic Time, SAT）。秒长采用 SI 定义的原子秒长，依时机插入 100 至 200 毫秒的间隔以与 UT2 同步（差异保持在 100 毫秒内）。

1966 年 [CCIR 第 374-1 号建议](https://search.itu.int/history/HistoryDigitalCollectionDocLibrary/4.277.43.en.1003.pdf)（见 281 页）采纳了这种做法，并且规定了具体细节。例如，载波频率与时间信号速率不偏移时，调整时机为每月第一日，调整量为 100 毫秒的整数倍。
