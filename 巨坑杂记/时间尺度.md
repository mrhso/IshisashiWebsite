...
[CCIR 第 374-1 号建议](https://search.itu.int/history/HistoryDigitalCollectionDocLibrary/4.277.43.en.1003.pdf)（见 281 页）采纳了这种做法，并且规定了具体细节。例如，载波频率与时间信号速率不偏移时，调整时机为每月第一日，调整量为 100 毫秒的整数倍。
