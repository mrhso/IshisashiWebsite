...
分析表达式之差，可以看出算法乙的结果总是大于算法甲；最大误差出现在 UTC 的 1960 年 1 月 1 日 00:00:00，为 $\dfrac{209452601676559162777869457667779}{999999942000001034999994150000000000000}\kern{3 mu}\text{s}\doteq2.095\times10^7\kern{3 mu}\text{s}$。
