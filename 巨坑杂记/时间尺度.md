...
根据 $\text{UTC}\_+=\text{UTC}\_-+s$ 与 $\text{MJD}\_{+\text{ UTC literal}}=\text{MJD}\_{-\text{ UTC literal}}+s$，依上式倒推 TAI-UTC 的表达式，列表如下。
...
[IERS EOC](https://hpiers.obspm.fr/iers/bul/bulc/UTC-TAI.history) 与 [IERS RS/PC](https://maia.usno.navy.mil/ser7/tai-utc.dat) 也提供了精确到 $10^7\kern{3 mu}\text{s}$ 的表达式。
