...
![](img/1370f25121502977062a317d069bd1c60f1fa522.png)

搜 `= 4;` 定位，记住数组名 `_2044` 与函数名 `_2045`：

![](img/c6c7663e949d2afac669afa8d6e5940314bc1fb0.png)

搜 `'+~'` 定位，找到上方的换行代码，并记住 `_2058`：

![](img/26bf1fb8f9d0d7994870dffba9bb1462b9dfe736.png)
```JavaScript
_2044.push(_2058);
_2049();
```
...
```
![](img/fa67f61658242b998b311b7a28346d8a1d784168.png)
