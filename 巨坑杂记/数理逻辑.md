...
(CS3) 设 A，B 和 C 是汇集，x 是字母。用 sAB 代表某种符号 s 将 A 与 B 联系起来得到的汇集，则 (C|x)(¬A)，(C|x)(A∨B)，(C|x)(sAB) 各与 ¬((C|x)A)，(C|x)A∨(C|x)B，s(C|x)A(C|x)B 完全相当。
...
考虑到 (CS3)，这表明关系 ((A|x)(¬R)→(∃x)(¬R))→((∀x)R→(A|x)(¬(¬R))) 是真的。
...
关系 (¬(¬R))→R 是真的，根据 (TL7)，关系 (A|x)(¬(¬R))→(A|x)R 是真的。
...
Theorem SP14 : forall R S T, proof ((R ->, S) ->, ((T ->, R) ->, (T ->, S))).
Proof.
intros.
assert (proof ((R ->, S) ->, ((T ->, R) ->, (T ->, S)))).
{ apply AL4. }
auto.
Qed.
```
